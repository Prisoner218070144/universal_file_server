...
class TestUploadHandler:
    ...
    def test_init(self):
        ...
        assert default_handler.root_drive == self.mock_config.ROOT_DRIVE  # Should be test_dir
    ...
    def test_cleanup_incomplete_uploads(self, mock_remove, mock_getmtime, mock_walk):
        ...
        with patch('time.time', return_value=current_time):
            cleanup_count = self.uploader.cleanup_incomplete_uploads(timeout_seconds=600)
