...
class TestRoutesIntegration:
    ...
    def setup_method(self):
        ...
        self.mock_config.FILE_EXTENSIONS = {
            ...
            'text': ['.txt', '.py', '.js', '.html', '.css', '.json', '.xml', '.csv', '.md', '.log', '.ini'],
            'other': []
        }
    ...
    def test_index_route(self):
        ...
        self.mock_model.get_parent_path.return_value = ""
        self.mock_model.count_file_types.return_value = {
            'folders': 1, 'videos': 0, 'audios': 0, 
            'images': 0, 'documents': 0, 'text': 1, 'others': 0
        }
        self.mock_model.get_files_by_type.return_value = {}
    ...
    def test_browse_folder_success(self):
        ...
        self.mock_model.get_folder_contents.return_value = (mock_items, None)
        self.mock_model.get_breadcrumbs.return_value = [{'name': 'folder1', 'path': 'folder1'}]
        self.mock_model.get_parent_path.return_value = ""
        self.mock_model.count_file_types.return_value = {
            'folders': 0, 'videos': 0, 'audios': 0, 
            'images': 0, 'documents': 0, 'text': 1, 'others': 0
    ...
    def test_browse_url_encoded_path(self):
        ...
        self.mock_model.get_folder_contents.side_effect = get_folder_contents_side_effect
        self.mock_model.get_breadcrumbs.return_value = [{'name': 'folder 1', 'path': 'folder 1'}]
        self.mock_model.get_parent_path.return_value = ""
        self.mock_model.count_file_types.return_value = {
            'folders': 0, 'videos': 0, 'audios': 0, 
            'images': 0, 'documents': 0, 'text': 1, 'others': 0
    ...
    def test_upload_files_success(self):
        ...
        response = self.client.post('/upload/folder1', data=data, content_type='multipart/form-data')
    ...
    def test_create_folder_success(self):
        ...
        response = self.client.post('/create_folder/folder1', 
    ...
    def test_create_file_success(self):
        ...
        response = self.client.post('/create_file/folder1', 
                                   data=json.dumps(data),
                                   content_type='application/json')
    ...
    def test_handle_range_request(self):
        ...
        with patch('controllers.routes.request', mock_request):
            response = _handle_range_request(test_file, file_size, 'bytes=2-5', 'text/plain')
