...
class TestBrowseFunctional:
    ...
    def _setup_patches(self):
        ...
        self.original_config = {attr: getattr(config, attr, None) for attr in dir(config) if not attr.startswith('_')}
    ...
    def test_create_new_folder(self):
        ...
        response = self.client.post('/create_folder/', 
    ...
    def test_upload_file(self):
        ...
        data = {
            'files[]': (BytesIO(b'test upload content'), 'upload_test.txt')
        }
